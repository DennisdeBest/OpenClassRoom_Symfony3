...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platform.purger' => 'getOcPlatform_PurgerService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_56781b1d46c910a95ad41c1562a107d879f1199d9ede8cd794c8a0a9afe8f7d2');
    ...
    /**
     * Gets the 'oc_platform.purger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Purger\OCPurger A OC\PlatformBundle\Purger\OCPurger instance.
     */
    protected function getOcPlatform_PurgerService()
    {
        return $this->services['oc_platform.purger'] = new \OC\PlatformBundle\Purger\OCPurger(5, $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('572b7641480f52.80862909')), true);
