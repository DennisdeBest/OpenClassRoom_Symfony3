    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            if (0 === strpos($pathinfo, '/platform/purge') && preg_match('#^/platform/purge(?:/(?P<days>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_purge')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::purgeAction',  'days' => 5,));
            }
